  ...
  return (
    <main>
      ...
      <section className="px-8 lg:px-24 md:px-16 pt-24 lg:pt-32 pb-16 max-w-7xl mx-auto">
        <div className="flex flex-wrap justify-center items-center">
          <div className="w-full lg:w-1/2 mb-6 lg:mb-0">
            <Image src={'/mockup-zenspire.png'} alt="mockup-zenspire" className=" px-8" width={2000} height={500}></Image>
          </div>
      ...
      <section className="relative lg:-mt-8">
        ...
        <div className="px-8 lg:px-24 md:px-16 pt-16 pb-32 lg:pb-64 max-w-7xl mx-auto">
          <div>
      ...
      {/* FAQ Section Start */}
      <section>
        <div className="px-8 lg:px-24 md:px-16 py-16 max-w-7xl mx-auto">
